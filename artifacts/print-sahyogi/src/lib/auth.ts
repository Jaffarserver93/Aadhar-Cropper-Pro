...
// ── Auth actions — reads/writes the `app_users` table directly in your
// Supabase database (this is the same data you see in Supabase's table
// editor, not Supabase's built-in Auth users list). ─────────────────────────
