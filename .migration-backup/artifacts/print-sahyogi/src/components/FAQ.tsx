...
const faqs = [
  ...
  },
  {
    ...
    answer: "EZONE Helper works on any modern web browser across desktop, laptop, tablet, and mobile devices. For printing, we recommend using a computer connected to a printer."
  },
  {
    ...
    <section id="faq" className="py-24 bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600">Everything you need to know about using EZONE Helper.</p>
        </div>
